...
def scrape(url):
    headers = {
        ...
        'user-agent': 'Mozilla/5.0 (X11; CrOS x86_64 8172.46.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.64 Safari/537.36',
...
with open("urls2.txt", 'r') as urllist, open('data.csv', 'w') as outfile:
